...
lstm_2    = LSTM(512 , input_shape=(X.shape[1], X.shape[2]), return_sequences = False )(lstm_1)
...
with open("models/dmlvh2_mLSTM_512_model.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("models/dmlvh2_mLSTM_512_weights.h5")
